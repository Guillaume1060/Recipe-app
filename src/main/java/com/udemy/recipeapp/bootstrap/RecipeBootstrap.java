package com.udemy.recipeapp.bootstrap;
import com.udemy.recipeapp.model.*;
import com.udemy.recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional // fix the lazy issue (to study)
